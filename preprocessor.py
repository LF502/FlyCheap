...
class Preprocessor:
    ...
    __cityClass =  {'北京首都': 1, '北京大兴': 1, '上海虹桥': 1, '上海浦东': 1, '广州': 1, 
                   '深圳': 1, '成都双流': 0.8, '成都天府': 0.8, '杭州': 0.8, '重庆': 0.8, 
    ...
    __cityLocation = {'北京首都': 0.2, '北京大兴': 0.2, '上海虹桥': 0, '上海浦东': 0, '广州': 0, 
                      '深圳': 0, '成都双流': 0.8, '成都天府': 0.8, '杭州': 0.1, '重庆': 0.7, 
